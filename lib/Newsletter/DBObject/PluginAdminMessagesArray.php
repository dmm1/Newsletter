...
class Newsletter_DBObject_PluginAdminMessagesArray extends Newsletter_DBObject_PluginBaseArray 
{
    function Newsletter_DBObject_PluginAdminMessagesArray($init=null, $where='')
    {
