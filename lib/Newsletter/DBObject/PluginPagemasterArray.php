...
class Newsletter_DBObject_PluginPagemasterArray extends Newsletter_DBObject_PluginBaseArray
{
    function Newsletter_DBObject_PluginPagemasterArray($init=null, $where='')
    {
