...
ProtoCheck = Class.create({
   initialize: function(options) {
      this.options = {
         checkClass:             'nl_checkbox',
         radioClass:             'nl_radiobutton',
         checkOnClass:           'nl_check_checked',
         checkOffClass:          'nl_check_unchecked',
         radioOnClass:           'nl_radio_checked',
         radioOffClass:          'nl_radio_unchecked',
         checkOnDisabledClass:   'nl_check_checked_disabled',
         checkOffDisabledClass:  'nl_check_unchecked_disabled',
         radioOnDisabledClass:   'nl_radio_checked_disabled',
         radioOffDisabledClass:  'nl_radio_unchecked_disabled',
         focusClass:             'nl_focus'
      };
