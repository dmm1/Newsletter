...
{modurl assign='nlUrl' modname="Newsletter" type="user" func="main" ot="archive" lang=$nllang fqurl=true}{$nlUrl|nlTreatUrl|html_entity_decode}
...
{modurl assign='nlUrl' modname="Newsletter" type="user" func="main" ot="unsubscribe" lang=$nllang fqurl=true}{$nlUrl|nlTreatUrl|html_entity_decode}