				...
				<div class="content">
					<table>
						<tr>
							<td align="center">
								<p>
									<a href="{modurl modname="Newsletter" type="user" func="main" ot="archive" lang=$nllang fqurl=true assign='url'}{$url|nlTreatUrl|safetext}"><strong>{gt text="Archive"}</strong></a> |
									<a href="{modurl modname="Newsletter" type="user" func="main" ot="tos" lang=$nllang fqurl=true assign='url'}{$url|nlTreatUrl|safetext}"><strong>{gt text="Terms of Service"}</strong></a> |
									<a href="{modurl modname="Newsletter" type="user" func="main" ot="unsubscribe" lang=$nllang fqurl=true assign='url'}{$url|nlTreatUrl|safetext}"><strong>{gt text="Unsubscribe"}</strong></a>
								</p>
							</td>
						</tr>
					</table>
